...
/*        method.addParameter("scope", "read,write");*/
    ...
    public String sendMsg(String requsetMapping, String accessToken, HashMap<String, String> params) throws IOException {
        HttpClient client = new HttpClient();
        GetMethod method = new GetMethod(url + requsetMapping);
...
/*        Set<String> strings = params.keySet();
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        JavaRequest f = new JavaRequest("http://localhost:8080");
        String accessToken = f.getAccessToken("string", "string", "test", "test");
